    ...
    return (
        <View style={styles.container}>
            ...
            <RadioButton.Group contentContainerStyle={styles.radioGroup} onValueChange={value => setValue(value)} value={value}>
                <RadioButton.Item label="PayPal" value="visa" color={primaryColor} labelStyle={styles.labelStyle} style={styles.radioItem} />
                <RadioButton.Item label="Google Pay" value="atm" labelStyle={styles.labelStyle} color={primaryColor} style={styles.radioItem} />
